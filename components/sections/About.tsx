...
export default function About() {
  return (
    <section id="about" className="mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-16">
      {/* Center aligned heading + paragraph */}
      <div className="text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center">
  About <span className="text-blue-600">Me</span>
</h2>
        <p className="mt-3 text-sm md:text-base text-gray-600 mx-auto max-w-3xl px-4">
      ...
      {/* Two Column Layout */}
      <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-start">
        {/* LEFT COLUMN */}
        <div>
          <div className="text-base md:text-lg font-semibold mb-4 text-center md:text-left">
          ...
          <div
            className="
              ...
              leading-[1.35]
              [&_h1]:text-xs sm:[&_h1]:text-sm [&_h2]:text-xs sm:[&_h2]:text-sm [&_h3]:text-xs sm:[&_h3]:text-sm
              [&_p]:text-[12px] sm:[&_p]:text-[13px]
              [&_li]:text-[12px] sm:[&_li]:text-[13px]
              [&_span]:text-[12px] sm:[&_span]:text-[13px]
            "
          >
